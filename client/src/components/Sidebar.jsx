...
unseenMessages, setUnseenMessages } = useContext(ChatContext);
  ...
  return (
    <div className={`bg-[#8185B2]/10 h-screen p-5 rounded-r-xl overflow-y-scroll
        ...
        <div className='pb-5'>
            <div className='flex justify-between items-center'>
                ...
                <div className='relative py-2 group'>
                    ...
                    <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-grey-600 text-gray-100 hidden
                group-hover:block'>
